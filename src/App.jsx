...
import { X, Plus, Play, Pause, SkipForward, SkipBack } from "lucide-react";
...
export default function App() {
  ...
  // Responsive: pantau lebar layar biar player menyesuaikan ukuran & posisi
  ...
  const playerWidth = Math.min(250, viewportWidth - 32); // sisakan margin 16px kiri-kanan
  const playerLeft = 16; // tetap nempel kiri, baik di desktop maupun layar kecil
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      /* thumb lebih kecil khusus slider volume vertikal */
            ...
            <div className="relative min-h-screen overflow-x-hidden">
              ...
              <div style={{
                ...
                >
                  {menuOpen
                    ...
                    : <img src="menu.png" width={28} height={28} style={{ objectFit: "contain" }} />}
                </button>

                {/* Icon nav — muncul saat menuOpen */}
                {[
                  { icon: <img src="hero.png" width={28} height={28} style={{ objectFit: "contain" }} />, label: "Home", href: "#hero" },
                  { icon: <img src="profile.png" width={28} height={28} style={{ objectFit: "contain" }} />, label: "About",    href: "#about"    },
                  { icon: <img src="project.png" width={28} height={28} style={{ objectFit: "contain" }} />, label: "Projects", href: "#projects" },
                  { icon: <img src="contact.png" width={28} height={28} style={{ objectFit: "contain" }} />, label: "Contact",  href: "#contact"  },
              ...
              {isMinimized && (
                <div style={{
                  ...
                  background: "linear-gradient(120deg, #1e0b38 0%, #6d28d9 45%, #0ea5a3 100%)",
                  borderRadius: isMobile ? 10 : 12, padding: isMobile ? "6px 8px" : "8px 12px",
                  display: "flex", alignItems: "center", gap: isMobile ? 6 : 10,
                  boxShadow: "0 4px 16px rgba(0,0,0,0.4)",
                  minWidth: isMobile ? Math.min(150, viewportWidth - 32) : 200,
                  maxWidth: isMobile ? Math.min(200, viewportWidth - 32) : 280,
                }}>
                  {currentVideo?.artwork && (
                    <img src={currentVideo.artwork} width={isMobile ? 24 : 32} height={isMobile ? 24 : 32} style={{ borderRadius: 6, flexShrink: 0 }} />
                  )}
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: isMobile ? 10 : 12, color: "white", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {currentVideo?.title || "No song playing"}
                    </div>
                    {isPlaying && (
                      <div style={{ fontSize: isMobile ? 9 : 10, color: "rgba(180,100,255,0.9)", marginTop: 2 }}>▶ Playing</div>
                    )}
                  </div>
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: isMobile ? 6 : 8, width: isMobile ? 22 : 28, height: isMobile ? 22 : 28,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      cursor: "pointer", fontSize: isMobile ? 11 : 14, flexShrink: 0,
                    }}
                  >▲</button>
                </div>
              )}
              ...
              <div
                style={{
                  ...
                  left: isMobile ? `${playerLeft}px` : "20px",
                  zIndex: 50,
                  background: "#1c1030",
                  borderRadius: isMobile ? "12px" : "14px",
                  padding: isMobile ? "8px" : "10px",
                  width: isMobile ? `${playerWidth}px` : "280px",
              ...
              >
                {/* Tombol minimize + add playlist - di luar kotak seperti semula di layar besar,
                    pindah ke dalam kotak hanya di layar kecil biar ga ketutupan/ke-clip */}
                {isMobile ? (
                  <div
                    style={{
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        display: "flex", alignItems: "center", justifyContent: "center",
                        width: 28, height: 28, boxShadow: "0 6px 14px rgba(0,0,0,0.18)", flexShrink: 0,
                      }}
                    ><Plus size={14} /></button>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        justifyContent: "center", fontSize: 14, boxShadow: "0 6px 14px rgba(0,0,0,0.18)", flexShrink: 0,
                      }}
                    >−</button>
                  </div>
                ) : (
                ...
                {showPlaylistMenu && selectedSong && (
                  <div
                    style={{
                      ...
                      left: Math.max(8, Math.min(showPlaylistMenu.left - 110, viewportWidth - 188)),
                ...
                {/* Controls */}
                <div style={{ display: "flex", justifyContent: "center", gap: "12px", alignItems: "center", marginTop: 16, width: "100%", position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", right: 0, display: "flex", alignItems: "center" }}>
                    {showVolume && (
                      <div style={{
                        ...
                        background: "rgba(20,10,40,0.85)", backdropFilter: "blur(8px)",
                        ...
                        <input
                          ...
                          style={{
                            ...
                            appearance: "none",
                            borderRadius: "4px",
                            background: `linear-gradient(to top, rgba(180,100,255,0.8) ${volume}%, rgba(255,255,255,0.15) ${volume}%)`,
                    ...
                    <button
                      ...
                      style={{ ...iconBtn, fontSize: 16, width: 24, textAlign: "center" }}
                      title="Volume"
                    >
                      🔊
                    </button>
