...
export default function App() {
  ...
  const playerWidth = Math.min(280, viewportWidth - 32); // sisakan margin 16px kiri-kanan
            ...
            <div className="relative min-h-screen overflow-x-hidden">
              ...
              {isMinimized && (
                <div style={{
                  ...
                  minWidth: isMobile ? Math.min(200, viewportWidth - 32) : 200,
                  maxWidth: isMobile ? Math.min(280, viewportWidth - 32) : 280,
                }}>
