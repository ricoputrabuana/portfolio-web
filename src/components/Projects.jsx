...
const projects = [
  ...
  {
    title: "Not Discovered Yet",
    desc:
      "This project has not been discovered yet",
    tags: ["None", "None", "None"],
    link: "#",
    type: "image",
    src: "/blank.png",
    ...
    >
      ...
      <div className="p-6">
        ...
        <div style={{ marginTop: "24px" }} className="text-left">
          <p className="font-mono uppercase text-purple-400/60 mb-2" style={{ fontSize: "12px", letterSpacing: "0.2em" }}>
            ✦ Crafting Material :
          </p>
