...
const projects = [
  ...
  },
  {
    ...
    desc:
      "A modular Discord bot with creative commands and a Railway-deployed backend — focused on communities and automation.",
    tags: ["Node.js", "Discord.js", "Railway"],
    link: "#",
    type: "image",
    src: "/images/discord-bot.jpg",
  },
  {
    title: "Night Racer Mini Animation",
    desc:
      "Miniature-style animated short combining AI-generated frames and handcrafted compositing — an experiment in mood and motion.",
    tags: ["AI Animation", "Video", "Compositing"],
    link: "#",
    type: "image",
    src: "/images/night-racer.jpg",
  },
];
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-4">
          {p.tags.map((tag, i) => (
            <span
              key={i}
              className="text-xs px-2 py-1 rounded-full bg-gradient-to-r from-purple-400/15 to-indigo-400/8 text-purple-200 border border-white/6"
            >
              {tag}
            </span>
          ))}
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-3 text-purple-300">Projects</h2>
