  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-4xl font-bold mb-8 text-purple-300 text-center">Projects</h2>
        <p className="text-sm sm:text-lg mb-10 text-gray-300 max-w-4xl mx-auto text-center">
