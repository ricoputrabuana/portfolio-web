...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative bg-[#12091e]/70 text-white py-24 px-6 backdrop-blur-sm z-10"
    >
      ...
      <div className="text-center">
        <h2 className="text-2xl sm:text-4xl font-bold mb-8 text-purple-300">
          Profile
        </h2>
        <p className="text-sm sm:text-lg mb-8 text-gray-300 max-w-4xl mx-auto">
          The skills, tools, and story behind every build. Developed through practice, refined through experience.
        </p>
      </div>
              ...
              <div style={{
                ...
                <div style={{ paddingLeft: 68 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8, minHeight: 24 }}>
                    <span style={{ color: "#c8a84b", fontSize: 14, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>Overview</span>
                  </div>
                  <p
                    lang="en"
                    style={{
