          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <div style={{
                ...
                <div style={{ paddingLeft: 68 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8, minHeight: 24 }}>
                    <span style={{ color: "#c8a84b", fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>Specialization</span>
                  </div>
            ...
            <div style={{
              ...
              <div style={{ paddingLeft: 68 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8, minHeight: 24 }}>
                  <span style={{ color: "#c8a84b", fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>Background</span>
                </div>
